    ...
    if(elementosSet){
        ...
        if(ejeX && ejeY){
            ...
            for(int i=0 ; i<asteroides->size() ; i++) {
                ...
                asteroidito.setPosition(posicion.x+((*asteroides)[i].pos.posicion.x+radio)/(2*radio)*dimensiones.x-asteroidito.getRadius(),
                                        posicion.y+((*asteroides)[i].pos.posicion.y+radio)/(2*radio)*dimensiones.y-asteroidito.getRadius());
            ...
            for(int i=0 ; i<asteroides->size() ; i++) {
                ...
                asteroidito.setPosition(posicion.x+((*asteroides)[i].pos.posicion.y+radio)/(2*radio)*dimensiones.x-asteroidito.getRadius(),
                                        posicion.y+((*asteroides)[i].pos.posicion.z+radio)/(2*radio)*dimensiones.y-asteroidito.getRadius());
                asteroidito.setFillColor(sf::Color::White);
